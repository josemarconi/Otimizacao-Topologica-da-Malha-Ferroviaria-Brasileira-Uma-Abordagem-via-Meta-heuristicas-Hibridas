...
const string DIR_OUTPUT = "../Outputs/";
...
int main()
{
    ...
    rede.exportarParaArquivo(DIR_OUTPUT + "grafo_mst.txt");
    // 2. BUSCA LOCAL PURA
    ...
    rede.exportarParaArquivo(DIR_OUTPUT + "grafo_hc.txt");
    ...
    rede.exportarParaArquivo(DIR_OUTPUT + "grafo_ils.txt");
    // GRASP
    cout << "   - Rodando GRASP...\n";
    clock_t t5 = clock();
    ...
    rede.exportarParaArquivo(DIR_OUTPUT + "grafo_grasp.txt");
    // VNS
    cout << "   - Rodando VNS...\n";
    clock_t t7 = clock();
    ...
    rede.exportarParaArquivo(DIR_OUTPUT + "grafo_vns.txt");
    // --- RELATÓRIO FINAL ---
    cout << "\n\n";
    cout << "====================================================================\n";
